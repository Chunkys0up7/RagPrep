...
class TestLLMMetadataExtractor:
    ...
    def test_extract_topics_with_llm(self, mock_openai):
        ...
        topics = self.extractor._extract_topics_with_llm("AI and machine learning are important")
    ...
    def test_extract_relationships_with_llm(self, mock_openai):
        ...
        relationships = self.extractor._extract_relationships_with_llm("John Doe works at Company Inc", entities)
    ...
    def test_generate_summary_with_llm(self, mock_openai):
        ...
        summaries = self.extractor._generate_summary_with_llm("AI and machine learning are important technologies")
...
class TestMetadataExtractorFactory:
    ...
    def test_create_llm_extractor(self):
        ...
        extractor = MetadataExtractorFactory.create_extractor("llm_powered", mock_config)
